        ...
        var st = {STANDARD: 1, OTHERS: -3}, at = [1, 28, 500], ft = function (t) {
            ...
            function t(t, n) {
                ...
                this.options = new N(n), t.setAttribute("data-scrollbar", "true"), t.setAttribute("tabindex", "-1"), B(t, {
                    overflow: "hidden",
                    outline: "none"
                }), window.navigator.msPointerEnabled && (t.style.msTouchAction = "none"), r.id = "scroll-content", r.className = "scroll-content", Array.from(t.childNodes).forEach((function (t) {
                    r.appendChild(t)
            ...
            return Object.defineProperty(t.prototype, "parent", {
                ...
                var o = function (t, n, e) {
                    ...
                    /* x axis was changed on "0". It was "-n" */
                    return r.renderByPixels && (n = Math.round(n), e = Math.round(e)), n = O(n, 0, u.x), e = O(e, 0, u.y), n !== o.x && c.xAxis.show(), e !== o.y && c.yAxis.show(), r.alwaysShowTracks || c.autoHideOnIdle(), n === o.x && e === o.y ? null : (o.x = n, o.y = e, B(s, {"-transform": "translate3d(" + 0 + "px, " + -e + "px, 0)"}), c.update(), {
                        offset: i({}, o),
                        limit: i({}, u)
                    })
                }(this, t, n);
